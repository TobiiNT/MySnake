...
{
    public class BfsController : ISnakeController
    {
        ...
        {
            BFSAlgorithm Algorithm = new BFSAlgorithm(this.Board, Snake.Head.Position);
            List<Point> ShortestPath = Algorithm.FindPath();
        ...
        public class BFSAlgorithm
        {
            ...
            {
                int MaxX = Cells.GetLength(0) - 1;
                int MaxY = Cells.GetLength(1) - 1;
